...
{d:1,t:"conceitos-nuvem",q:"Adicionar mais memória e mais vCPUs a uma máquina virtual existente é um exemplo de:",a:["Escala horizontal (scale out)","Escala vertical (scale up)","Elasticidade automática","Balanceamento de carga"],c:[1],e:"Escala vertical aumenta a capacidade de uma única instância. Escala horizontal aumenta o número de instâncias que atendem à carga."},
...
{d:2,t:"redes-computacao",q:"Duas redes virtuais no Azure precisam se comunicar diretamente pela rede da Microsoft, sem passar pela internet pública e sem gateway de VPN. Qual recurso deve ser usado?",a:["Emparelhamento de rede virtual (peering)","Gateway de VPN site a site","ExpressRoute","Azure DNS"],c:[0],e:"O emparelhamento conecta duas redes virtuais pela rede de backbone da Microsoft, com baixa latência e sem tráfego pela internet pública."},
{d:2,t:"redes-computacao",q:"Uma organização precisa de uma conexão privada e dedicada entre o datacenter local e o Azure, que não trafegue pela internet pública e ofereça largura de banda consistente. Qual serviço atende?",a:["Gateway de VPN ponto a site","ExpressRoute","Emparelhamento de rede virtual","Azure Front Door"],c:[1],e:"O ExpressRoute estabelece conectividade privada com o Azure por meio de um provedor de conectividade, sem usar a internet pública, com maior previsibilidade de latência e largura de banda."},
