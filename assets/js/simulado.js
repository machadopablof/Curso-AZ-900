...
{d:2,t:"revisao-containers",q:"Um processo precisa ser executado somente quando um arquivo novo chega a uma conta de armazenamento, sem servidor dedicado e com cobrança apenas pela execução. Qual serviço é o mais adequado?",a:["Azure Functions","Máquinas Virtuais do Azure","Azure Files","Azure ExpressRoute"],c:[0],e:"O Azure Functions é um serviço sem servidor orientado a eventos: o código é executado em resposta a um gatilho e a cobrança acompanha o consumo, sem infraestrutura para administrar."},
...
{d:2,t:"revisao-rede",q:"Duas redes virtuais no Azure precisam se comunicar diretamente pela rede da Microsoft, sem passar pela internet pública e sem gateway de VPN. Qual recurso deve ser usado?",a:["Emparelhamento de rede virtual (peering)","Gateway de VPN site a site","ExpressRoute","Azure DNS"],c:[0],e:"O emparelhamento conecta duas redes virtuais pela rede de backbone da Microsoft, com baixa latência e sem tráfego pela internet pública."},
{d:2,t:"revisao-rede",q:"Uma organização precisa de uma conexão privada e dedicada entre o datacenter local e o Azure, que não trafegue pela internet pública e ofereça largura de banda consistente. Qual serviço atende?",a:["Gateway de VPN ponto a site","ExpressRoute","Emparelhamento de rede virtual","Azure Front Door"],c:[1],e:"O ExpressRoute estabelece conectividade privada com o Azure por meio de um provedor de conectividade, sem usar a internet pública, com maior previsibilidade de latência e largura de banda."},
{t:"revisao-storage",d:2,q:"Registros de auditoria precisam ser mantidos por sete anos, com acesso muito raro e o menor custo de armazenamento possível. Qual camada de blob deve ser escolhida?",a:["Quente (hot)","Fria (cool)","Arquivo morto (archive)","Premium"],c:[2],e:"A camada de arquivo morto tem o menor custo de armazenamento, em troca do maior tempo de recuperação e de custos de acesso mais altos — perfil típico de retenção legal de longo prazo."},
{t:"revisao-storage",d:2,q:"Qual opção de redundância replica os dados entre zonas de disponibilidade da região primária e também para uma região secundária?",a:["LRS","ZRS","GRS","GZRS"],c:[3],e:"LRS mantém cópias em um único datacenter; ZRS replica entre zonas na mesma região; GRS replica para a região secundária; GZRS combina as duas proteções — zonas na região primária e cópia na região secundária."},
{t:"revisao-storage",d:2,q:"Uma equipe precisa de um compartilhamento de arquivos totalmente gerenciado, acessível por SMB e montável tanto por servidores locais quanto por VMs do Azure. Qual serviço deve usar?",a:["Armazenamento de Blobs","Arquivos do Azure (Azure Files)","Armazenamento de Filas","Azure Data Box"],c:[1],e:"O Azure Files oferece compartilhamentos de arquivos gerenciados acessíveis por SMB (e NFS), permitindo montar a mesma unidade de rede em ambientes locais e na nuvem."},
