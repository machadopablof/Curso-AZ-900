...
{t:"revisao-storage-regioes",d:2,q:"Uma equipe precisa de um compartilhamento de arquivos totalmente gerenciado, acessível por SMB e montável tanto por servidores locais quanto por VMs do Azure. Qual serviço deve usar?",a:["Armazenamento de Blobs","Arquivos do Azure (Azure Files)","Armazenamento de Filas","Azure Data Box"],c:[1],e:"O Azure Files oferece compartilhamentos de arquivos gerenciados acessíveis por SMB (e NFS), permitindo montar a mesma unidade de rede em ambientes locais e na nuvem."},
