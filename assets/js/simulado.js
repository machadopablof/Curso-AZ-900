/* ============================================================
   ...
   ============================================================ */
const BANCO = [
/* ---------- DOMÍNIO 1 — Conceitos de nuvem (15) ---------- */
...
{d:1,q:"Qual das opções abaixo é considerada um benefício adicional da adoção da nuvem, relacionado à utilização mais eficiente da infraestrutura e à otimização de recursos?",a:["Previsibilidade","Sustentabilidade","Governança","Gerenciabilidade"],c:[1],e:"Sustentabilidade é um benefício da nuvem relacionado à utilização mais eficiente da infraestrutura, à otimização de recursos e à redução do impacto ambiental de operar datacenters em grande escala."},

/* ---------- DOMÍNIO 2 — Arquitetura e serviços (26) ---------- */
...
{d:2,q:"Uma aplicação precisa distribuir tráfego de rede entre várias VMs de back-end para melhorar a disponibilidade, sem que o serviço precise inspecionar o conteúdo da camada de aplicação (como URLs). Qual serviço é o mais adequado?",a:["Application Gateway","Azure Front Door","Load Balancer","Azure DNS"],c:[2],e:"O Load Balancer distribui tráfego de rede (camada de transporte) entre recursos, sem inspecionar o conteúdo da aplicação. Application Gateway e Front Door atuam na camada de aplicação web."},
{d:2,q:"Uma aplicação web hospedada dentro de uma única região e de uma Virtual Network precisa de roteamento baseado em URL e terminação TLS para o tráfego de entrada. Qual serviço é mais indicado?",a:["Azure Front Door","Load Balancer","Application Gateway","ExpressRoute"],c:[2],e:"O Application Gateway é um balanceador de camada de aplicação para cenários regionais dentro de uma VNet, com recursos como roteamento baseado em URL, terminação TLS e, conforme a configuração, WAF. O Front Door atua em escala global."},
{d:2,q:"Uma empresa tem usuários em vários continentes acessando uma aplicação web, e precisa de um serviço que ofereça roteamento global, aceleração e alta disponibilidade entre múltiplas regiões. Qual serviço é o mais indicado?",a:["Load Balancer","Application Gateway","Azure Front Door","Azure Bastion"],c:[2],e:"O Azure Front Door é um serviço global para aplicações web, oferecendo roteamento global, aceleração, alta disponibilidade, um ponto de entrada global e recursos de segurança, adequado para audiências distribuídas geograficamente."},
{d:2,q:"Qual afirmação compara corretamente Load Balancer e Application Gateway?",a:["Load Balancer opera na camada de aplicação e Application Gateway na camada de rede","Ambos operam exclusivamente na camada de rede, sem nenhuma diferença prática","Load Balancer distribui tráfego de rede; Application Gateway é voltado para tráfego de aplicações web, com recursos como roteamento por URL","Application Gateway substitui completamente a necessidade de um Load Balancer em qualquer cenário"],c:[2],e:"Load Balancer → tráfego de rede. Application Gateway → aplicação web, com recursos de camada 7 como roteamento baseado em URL e terminação TLS."},
{d:2,q:"Uma equipe precisa armazenar e gerenciar com segurança certificados TLS, chaves de criptografia e segredos de aplicação (como strings de conexão), com controle de acesso centralizado. Qual serviço deve ser usado?",a:["Microsoft Purview","Azure Policy","Azure Key Vault","Resource Locks"],c:[2],e:"O Azure Key Vault armazena e gerencia com segurança secrets, chaves e certificados, centralizando o controle de acesso a esses itens sensíveis."},
{d:2,q:"Qual afirmação sobre o Azure Key Vault está correta?",a:["É um serviço de armazenamento de arquivos de uso geral, como o Azure Files","Substitui totalmente a necessidade de RBAC para controlar acesso a recursos","É voltado ao armazenamento seguro de secrets, chaves e certificados, não sendo um storage comum de arquivos","Só pode ser usado por máquinas virtuais com Windows"],c:[2],e:"Key Vault não é um storage comum de arquivos: ele é voltado especificamente ao armazenamento seguro e ao gerenciamento de secrets, chaves e certificados."},
{d:2,q:"Sobre criptografia no Azure, qual par de conceitos descreve as duas formas principais em que os dados podem estar protegidos?",a:["Dados em cache e dados temporários","Dados públicos e dados privados","Dados em repouso e dados em trânsito","Dados replicados e dados arquivados"],c:[2],e:"Criptografia de dados em repouso protege dados armazenados; criptografia em trânsito protege dados durante a transmissão pela rede. O Key Vault ajuda a gerenciar as chaves usadas nesses processos."},
